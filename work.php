...
<main id="work-experience" class="about-content" role="main" aria-labelledby="work-heading">
  ...
  <section class="second-section" aria-labelledby="payactiv-heading">
    ...
    <ul>
      ...
      <li><strong>Established front-end workflows and documentation standards</strong> utilizing Azure DevOps, Confluence, and Notion, significantly improving cross-team collaboration and onboarding speed.</li>
      <li><strong>Engineered a modular, high-performance codebase</strong> that reduced technical debt and enabled faster, more reliable feature releases across web and mobile platforms.</li>
    </ul>
  </section>

  <section class="second-section" aria-labelledby="freelance-heading">
    <h3 id="freelance-heading">Freelance Full-Stack Developer</h3>
  ...
  <section class="second-section" aria-labelledby="tenderling-heading">
    <h3 id="tenderling-heading">Full-Stack Developer</h3>
  ...
  <section class="third-section" aria-labelledby="hometown-heading">
    <h3 id="hometown-heading">Front End Software Engineer</h3>
  ...
  <section class="third-section" aria-labelledby="storage-heading">
    <h3 id="storage-heading">Front End Software Engineer</h3>
  ...
  <section class="third-section" aria-labelledby="morris-heading">
    <h3 id="morris-heading">Full Stack Software Engineer</h3>
  ...
  <section class="third-section" aria-labelledby="river-heading">
    <h3 id="river-heading">Full Stack Software Engineer</h3>
